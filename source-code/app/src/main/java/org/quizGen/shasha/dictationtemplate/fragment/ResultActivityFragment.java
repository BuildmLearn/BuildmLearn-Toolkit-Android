package org.quizGen.shasha.dictationtemplate.fragment;
...
import org.quizGen.shasha.dictationtemplate.data.DataUtils;
import org.quizGen.shasha.dictationtemplate.data.DictContract;
import org.quizGen.shasha.dictationtemplate.data.DictDb;
import org.quizGen.shasha.utilities.diff_match_patch;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        maintoolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getActivity().getSupportFragmentManager().beginTransaction().replace(((ViewGroup) getView().getParent()).getId(), org.quizGen.shasha.dictationtemplate.fragment.MainActivityFragment.newInstance()).addToBackStack(null).commit();
            }
        });
            ...
            case DETAIL_LOADER:
                ...
                rootView.findViewById(R.id.restart).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Fragment frag = org.quizGen.shasha.dictationtemplate.fragment.DetailActivityFragment.newInstance();
